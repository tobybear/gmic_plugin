...
/*
#define PF_OutFlag2_I_MIX_GUID_DEPENDENCIES			(1 << 21)
#define PF_OutFlag2_AE13_5_THREADSAFE				(1 << 22)
#define PF_OutFlag2_SUPPORTS_GET_FLATTENED_SEQUENCE_DATA (1 << 23)
#define PF_OutFlag2_CUSTOM_UI_ASYNC_MANAGER			(1 << 24)
#define PF_OutFlag2_SUPPORTS_GPU_RENDER_F32			(1 << 25)
#define PF_OutFlag2_RESERVED12						(1 << 26)
#define PF_OutFlag2_SUPPORTS_THREADED_RENDERING	 (1 << 27)
#define PF_OutFlag2_MUTABLE_RENDER_SEQUENCE_DATA_SLOWER (1 << 28)
*/
...
resource 'PiPL' (16000) {
	{	/* array properties: 12 elements */
		...
		/* [8] */
		AE_Effect_Version {
			(PLUGIN_MAJOR_VERSION << 19) + (PLUGIN_MINOR_VERSION << 15) + (PLUGIN_BUG_VERSION << 11) + PLUGIN_BUILD_VERSION
		},
		/* [9] */
